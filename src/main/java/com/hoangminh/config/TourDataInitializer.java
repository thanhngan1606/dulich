...
public class TourDataInitializer implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        if (tourRepository.count() == 0) {
            ...
            createTour(1L, "Tour Đà Nẵng - Hội An", "Khám phá vẻ đẹp của Đà Nẵng và phố cổ Hội An", 
                      ...
                      new Date(124, 2, 15), new Date(124, 2, 17), "Đà Nẵng, Hội An", "Tour trong nước", "tour1.jpg", "TP.HCM", "Đang hoạt động", 2500000L);
            ...
            createTour(2L, "Tour Nha Trang", "Tận hưởng không khí biển Nha Trang", 
                      ...
                      new Date(124, 2, 20), new Date(124, 2, 21), "Nha Trang", "Tour trong nước", "tour2.jpg", "TP.HCM", "Đang hoạt động", 3000000L);
            ...
            createTour(3L, "Tour Phú Quốc", "Khám phá đảo ngọc Phú Quốc", 
                      ...
                      new Date(124, 3, 1), new Date(124, 3, 4), "Phú Quốc", "Tour trong nước", "tour3.jpg", "TP.HCM", "Đang hoạt động", 4000000L);
            
            createTour(4L, "Tour Sapa", "Khám phá vùng núi Tây Bắc", 
                      3, "Tham quan Fansipan, Bản Cát Cát, Thác Bạc, Chợ Sapa", 
                      new Date(124, 3, 10), new Date(124, 3, 12), "Sapa", "Tour trong nước", "tour4.jpg", "Hà Nội", "Đang hoạt động", 3500000L);
            
            createTour(5L, "Tour Huế", "Khám phá cố đô Huế", 
                      2, "Tham quan Đại Nội, Lăng Tự Đức, Chùa Thiên Mụ, Sông Hương", 
                      new Date(124, 3, 15), new Date(124, 3, 16), "Huế", "Tour trong nước", "tour5.jpg", "TP.HCM", "Đang hoạt động", 2000000L);
            ...
            createTour(6L, "Tour Thái Lan - Bangkok", "Khám phá thủ đô Thái Lan", 
                      ...
                      new Date(124, 4, 1), new Date(124, 4, 4), "Bangkok, Thái Lan", "Tour ngoài nước", "tour6.jpg", "TP.HCM", "Đang hoạt động", 8000000L);
            ...
            createTour(7L, "Tour Singapore", "Khám phá đảo quốc sư tử", 
                      ...
                      new Date(124, 4, 10), new Date(124, 4, 12), "Singapore", "Tour ngoài nước", "tour7.jpg", "TP.HCM", "Đang hoạt động", 12000000L);
            ...
            createTour(8L, "Tour Malaysia - Kuala Lumpur", "Khám phá thủ đô Malaysia", 
                      ...
                      new Date(124, 4, 20), new Date(124, 4, 22), "Kuala Lumpur, Malaysia", "Tour ngoài nước", "tour8.jpg", "TP.HCM", "Đang hoạt động", 9000000L);
            
            createTour(9L, "Tour Nhật Bản - Tokyo", "Khám phá thủ đô Nhật Bản", 
                      5, "Tham quan Tokyo Tower, Senso-ji, Shibuya, Mount Fuji, Disneyland", 
                      new Date(124, 5, 1), new Date(124, 5, 5), "Tokyo, Nhật Bản", "Tour ngoài nước", "tour9.jpg", "TP.HCM", "Đang hoạt động", 25000000L);
            ...
            createTour(10L, "Tour Hàn Quốc - Seoul", "Khám phá thủ đô Hàn Quốc", 
                      ...
                      new Date(124, 5, 10), new Date(124, 5, 13), "Seoul, Hàn Quốc", "Tour ngoài nước", "tour10.jpg", "TP.HCM", "Đang hoạt động", 20000000L);
    ...
    private void createTour(Long id, String tenTour, String gioiThieu, Integer soNgay, String noiDung, 
                           Date ngayKhoiHanh, Date ngayKetThuc, String diemDen, String loaiTour, 
                           String anhTour, String diemKhoiHanh, String trangThai, Long giaTour) {
        Tour tour = new Tour();
        tour.setId(id);
        ...
        tour.setLoai_tour(loaiTour); // String ENUM
        tour.setAnh_tour(anhTour);
        tour.setDiem_khoi_hanh(diemKhoiHanh);
        tour.setTrang_thai(trangThai); // String ENUM
